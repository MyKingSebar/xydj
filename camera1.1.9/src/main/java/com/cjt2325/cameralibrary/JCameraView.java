...
import com.cjt2325.cameralibrary.listener.Yjlistener;
...
//    private static final String TAG = "JCameraView";
    ...
    private RelativeLayout mYjBottom;
    private TextView mYjNo;
    private TextView mYjGo;
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.camera_view_jc2, this);
        ...
        mCaptureLayout.setYjLisenter(new Yjlistener() {
            @Override
            public void finish() {
                mYjBottom.setVisibility(VISIBLE);
            }
        });
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureListener() {
            ...
            public void takePictures() {
                ...
                mYjBottom.setVisibility(INVISIBLE);
