 ...
 *                        ..,:::;;;;:::,,.    
 */
public final class InviteRelationshipAdapter extends MultipleRecyclerAdapter {
    ...
    public InviteRelationshipAdapter(List<MultipleItemEntity> data) {
        super(data);
        //添加item布局
            ...
            case YjIndexItemType.ROBOT_REMINDSETTING_ADD_TYPE:
                ...
                cl.setOnClickListener(v -> {
                    if(mCommonListener!=null){
                        mCommonListener.commonClick(id+"");
                    }
                });
                //赋值
