...
public class RobotCallSettingFriendListDataConverter extends DataConverter {
    ...
    public ArrayList<MultipleItemEntity> convert() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            final MultipleItemEntity entity = MultipleItemEntity.builder()
                    .setField(MultipleFields.ITEM_TYPE, YjIndexItemType.ROBOT_CALLSETTING_FRIENDLIST)
