...
public class RobotCallSettingFriendListDelegate extends LatteDelegate implements CommonStringClickListener,SwipeRefreshLayout.OnRefreshListener{
    RecyclerView mRecyelerView=null;
    String token = null;
    SwipeRefreshLayout mRefreshLayout = null;
    RobotCallSettingFriendListAdapter mAdapter=null;
    ...
    public void getFriends() {
        ...
        String url = "friend/query_friends";
                ...
                .subscribe(new BaseObserver<String>(getContext()) {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (TextUtils.equals(status, "1001")) {
                            List<MultipleItemEntity> data = new RobotCallSettingFriendListDataConverter()
                                    .setJsonData(response)
                                    .convert();
                            if(data==null){
                                return;
                            }
                            mAdapter = new RobotCallSettingFriendListAdapter(data);
