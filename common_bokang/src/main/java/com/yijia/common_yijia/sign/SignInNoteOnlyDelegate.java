...
public class SignInNoteOnlyDelegate extends LatteDelegate implements ITimeListener {
    ...
    void onClickSignIn() {
        if (checkForm()) {
            ...
            RxRestClient.builder()
                    ...
                    .params("password", mNote.getText().toString())
                    .params("loginType", "1")//1-手机号验证码，2-账号密码，3-微信
                    .params("machineType", "1")//机器类型：1-手机，2-机器人
                    .params("wxCode","")//微信登录时，不能为空
                    .params("macAddr","")//Mac
                    .build()
                    .post()
...
//            mPhone.setError(null);
    ...
    public Object setLayout() {
        return R.layout.delegate_sign_only_yijia;
    }
