package com.example.latte.ui.toast;
...
public class RxToast {
    ...
    public static void normal(@NonNull String message) {
        normal(Latte.getApplicationContext(), message, Toast.LENGTH_SHORT, null, false).show();
    }

    public static void normal(@NonNull String message, Drawable icon) {
        normal(Latte.getApplicationContext(), message, Toast.LENGTH_SHORT, icon, true).show();
    }

    public static void normal(@NonNull String message, int duration) {
        normal(Latte.getApplicationContext(), message, duration, null, false).show();
    }

    public static void normal(@NonNull String message, int duration, Drawable icon) {
        normal(Latte.getApplicationContext(), message, duration, icon, true).show();
    }

    public static Toast normal(@NonNull String message, int duration, Drawable icon, boolean withIcon) {
        return custom(Latte.getApplicationContext(), message, icon, DEFAULT_TEXT_COLOR, duration, withIcon);
    }

    public static void warning(@NonNull String message) {
        warning(Latte.getApplicationContext(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void warning(@NonNull String message, int duration) {
        warning(Latte.getApplicationContext(), message, duration, true).show();
    }

    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(Latte.getApplicationContext(), message, getDrawable(Latte.getApplicationContext(), R.mipmap.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }

    public static void info(@NonNull String message) {
        info(Latte.getApplicationContext(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void info(@NonNull String message, int duration) {
        info(Latte.getApplicationContext(), message, duration, true).show();
    }

    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(Latte.getApplicationContext(), message, getDrawable(Latte.getApplicationContext(), R.mipmap.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }

    public static void success(@NonNull String message) {
        success(Latte.getApplicationContext(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void success(@NonNull String message, int duration) {
        success(Latte.getApplicationContext(), message, duration, true).show();
    }

    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(Latte.getApplicationContext(), message, getDrawable(Latte.getApplicationContext(), R.mipmap.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }

    public static void error(@NonNull String message) {
        error(Latte.getApplicationContext(), message, Toast.LENGTH_SHORT, true).show();
    }
    ...
    public static void error(@NonNull String message, int duration) {
        error(Latte.getApplicationContext(), message, duration, true).show();
    }

    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        return custom(Latte.getApplicationContext(), message, getDrawable(Latte.getApplicationContext(), R.mipmap.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }
    ...
    public static void showToastShort(String str) {
        Toast.makeText(Latte.getApplicationContext(), str, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastShort(int resId) {
        Toast.makeText(Latte.getApplicationContext(), Latte.getApplicationContext().getString(resId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastLong(String str) {
        Toast.makeText(Latte.getApplicationContext(), str, Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToastLong(int resId) {
        Toast.makeText(Latte.getApplicationContext(), Latte.getApplicationContext().getString(resId), Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToast(String msg) {
        if (mToast == null) {
            mToast = Toast.makeText(Latte.getApplicationContext(), msg, Toast.LENGTH_LONG);
        } else {
            mToast.setText(msg);
        }
        mToast.show();
    ...
    public static void showToast(int resId) {
        if (mToast == null) {
            mToast = Toast.makeText(Latte.getApplicationContext(), Latte.getApplicationContext().getString(resId), Toast.LENGTH_LONG);
        } else {
            mToast.setText(Latte.getApplicationContext().getString(resId));
        }
        mToast.show();
    }
