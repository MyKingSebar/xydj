...
import com.example.commcon_xfyun.util.FucUtil;
import com.example.commcon_xfyun.util.JsonParser;
...
//        if (isShowDialog) {
    ...
    // 上传联系人
    public void iatUploadContacts() {
        showTip(mContext.getString(R.string.text_upload_contacts));
