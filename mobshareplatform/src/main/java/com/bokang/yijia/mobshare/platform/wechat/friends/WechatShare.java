package com.bokang.yijia.mobshare.platform.wechat.friends;

import com.bokang.yijia.mobshare.entity.ResourcesManager;
import com.bokang.yijia.mobshare.listener.MyPlatformActionListener;
...
private PlatformActionListener platformActionListener;
	public WechatShare(){
		this.platformActionListener = new MyPlatformActionListener(MobSDK.getContext());
...
//		platform.share(shareParams);
	...
	public void shareWebpager(String text,String title,String url,String imgurl){
//		Platform platform = ShareSDK.getPlatform(Wechat.NAME);
//		Platform.ShareParams shareParams = new  Platform.ShareParams();
//		shareParams.setText(ResourcesManager.getInstace(MobSDK.getContext()).getText());
//		shareParams.setTitle(ResourcesManager.getInstace(MobSDK.getContext()).getTitle());
